...
pub struct Term {
    ...
    #[serde(rename = "nameShort", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "sixtyPercentCompleteDate", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub sixty_percent_complete_date: Option<Option<String>>,
    /// The academic year to which this Term belongs
    #[serde(rename = "associatedAcademicYear", skip_serializing_if = "Option::is_none")]
