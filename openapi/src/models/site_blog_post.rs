...
pub struct SiteBlogPost {
    ...
    #[serde(rename = "delegatedAuthorName", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub delegated_author_name: Option<Option<String>>,
    /// Link to the WCMS profiel of the delegated author
    #[serde(rename = "delegatedAuthorUri", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
