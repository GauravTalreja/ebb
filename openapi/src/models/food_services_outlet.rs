...
pub struct FoodServicesOutlet {
    ...
    #[serde(rename = "outlettype", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub outlettype: Option<Option<Vec<crate::models::OutletType>>>,
    #[serde(rename = "outletlocation", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "cuisine", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub cuisine: Option<Option<Vec<crate::models::Cuisine>>>,
    #[serde(rename = "openinghours", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub openinghours: Option<Option<Vec<crate::models::OpeningHour>>>,
    #[serde(rename = "paymentaccepted", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "hourschange", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "franchisemenu", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
