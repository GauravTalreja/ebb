...
pub struct SiteOpportunity {
    ...
    #[serde(
        rename = "postedOrOpenDateTimeZone",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "applicationDeadlineDate",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
