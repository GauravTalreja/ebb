...
pub struct Class {
    ...
    #[serde(rename = "courseComponent", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub course_component: Option<Option<String>>,
    /// Associated class code for this class
    #[serde(rename = "associatedClassCode", skip_serializing_if = "Option::is_none")]
    pub associated_class_code: Option<i32>,
    /// Indicates the maximum number of students that can enroll in this class
    #[serde(rename = "maxEnrollmentCapacity", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "scheduleData", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub schedule_data: Option<Option<Vec<crate::models::ClassSchedule>>>,
    /// Instructor data for this class
    #[serde(rename = "instructorData", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
